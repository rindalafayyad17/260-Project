...
sep_cities <- sub %>% separate(City, c("City1", "City2", "City3"), sep = "-") #seperating the entries that include multiple city names into different columns
...
colnames(df3)[1] <- "City"
#creating a new dataframe with the third city column only
